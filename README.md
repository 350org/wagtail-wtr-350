...
|---|---|---|---|
| Country variant | `pt-br`, `fr-fr` | `/brasil/`, `/france/` | A country site whose language has more than one home |
| Plain language code | `fr`, `es` | `/fr/about/`, `/es/about/` | Translating an individual global page |
